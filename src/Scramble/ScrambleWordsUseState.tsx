...
export const ScrambleWords = () => {
    ...
    const handleGuessSubmit = (e: React.FormEvent) => {
        ...
        if (guess === currentWord) {
            console.log('Adivinanza correcta!');
            ...
            // obtiene las nuevas palabras sin la actual
            const newWords = words.slice(1);
            // actualiza los puntos
            setPoints(points + 1);
            // limpia el input caja de texto
            setGuess('');
            // establece las palabras restantes sin la actual
            setWords(newWords);
            // establece la nueva palabra actual a evaluar
            setCurrentWord(newWords[0]);
            // establece la nueva palabra desordenada
            setScrambledWord(scrambleWord(newWords[0] || ''));
            // retorna para evitar más ejecuciones
            return;
        }

        console.log('Adivinanza incorrecta');
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-2">
                        Palabras desordenadas Scramble for Kids
                    </h1>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        placeholder="Ingresa tu palabra ordenada..."
